...
"""autogenerated by genpy from api/moveAction.msg. Do not edit."""
import codecs
import sys
...
class moveAction(genpy.Message):
  _md5sum = "57ea9e5b8cc07aad506acd024e6a612f"
  _type = "api/moveAction"
...
"""
  ...
  _slot_types = ['api/moveActionGoal','api/moveActionResult','api/moveActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = api.msg.moveActionGoal()
      if self.action_result is None:
        self.action_result = api.msg.moveActionResult()
      if self.action_feedback is None:
        self.action_feedback = api.msg.moveActionFeedback()
    else:
      self.action_goal = api.msg.moveActionGoal()
      self.action_result = api.msg.moveActionResult()
      self.action_feedback = api.msg.moveActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_goal.goal.request)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.request:
        length = len(val1)
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.request.append(val1)
      _x = self
      start = end
      end += 12
